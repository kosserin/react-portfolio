  ...
  return (
    <StyledIntro>
      <StyledTopPart>
        ...
        <h2 className="style-h2 color-white mb-4">
          Skillful Frontend Developer
        </h2>
        ...
        <StyledLink href="#">
          <span className="style-button">kostic.andrija00@gmail.com</span>
          <svg
            width="246"
            height="6"
            viewBox="0 0 246 6"
          ...
          >
            <path
              d="M245 4.9979C145.993 -1.33803 13.6392 0.776049 1 5"
              stroke="#DBDBDB"
            />
          </svg>
        </StyledLink>
